...
<details markdown="1">
<summary markdown="1">This experiment also came with an epilogue. It's password-protected behind the code to the final riddle, which shouldn't be that hard to get to?</summary>
