...
<details markdown="1">
<summary markdown="1">Spoiler alert: it went kind of badly.</summary>
...
<details markdown="1">
<summary markdown="1">Spoilery Details</summary>
...
<summary markdown="1">...OK, let's talk about funny farms.</summary>
...
Of course, these were cut out of a late round of that Mystery Hunt, so it's got a difficulty curve to match. There were a lot of hard puzzles, though our team managed to strike one particular puzzle with a metric mountain of cheese (by straight-up guessing the answer).
...
<summary markdown="1">Spoiler alert: basically the same story.</summary>
...
I liked the previous Huntinality (though, generally, more on aesthetics than on puzzles, and also because birb). So what did they cook this year?
...
-   [🤫](https://www.huntinality.com/puzzles/puzzle_4). See previous discussion about funny farms, except this time it's throwing the entire Unicode emoji block at the wall, and the only saving grace is that it can be solved around. You don't even have enumerations to help you, because everything has an enumeration of 1. I never got anywhere past the starting node.
